## This package
This package is a copy of [this](https://github.com/gkngkc/UnityStandaloneFileBrowser) project, packaged for use with UPM.
With UPM, the project can be included in a project without checking in the source code.
